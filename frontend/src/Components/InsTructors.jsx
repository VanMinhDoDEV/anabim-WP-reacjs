//intructors with page intructors
      ...
      {instructorData
        ...
        .map((item, index) => (
          ...
          <div className=" h-[270px] rounded-t-md  relative mx-auto  overflow-hidden">
             <Link to={`/giang-vien/${item.slug}`}>
              ...
              <ul className=" justify-center bg-primary rounded-tl-md transition-all duration-100 flex ">
                  <li>
                  <a
                      href={item.meta.social.facebook || "#"}
                  ...
                  <li>
                  <a
                      href={item.meta.social.linkedin || "#"}
          ...
          <div className="course-content p-6">
            ...
            <div>{item.meta._tutor_profile_job_title}</div>
          </div>
          </div>
      ))}
</div>
